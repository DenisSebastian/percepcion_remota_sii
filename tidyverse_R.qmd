...
![](imagenes/tidyverse.png){fig-aling="center" width="300"}
...
<center>![](imagenes/tidy_frame.svg){width="80%"}</center>
...
<center>![](imagenes/dplyr_variables.png){width="70%"}</center>
...
<center>![](imagenes/dplyr_group_by.png){width="70%"}</center>
